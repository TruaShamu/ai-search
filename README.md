...
reranker, RAG, query understanding, eval framework and ETL. [`web/`](web/README.md) is
the Next.js frontend, `infra/` the Bicep templates, `scripts/` the cloud-embedding and
eval harnesses, and `data/` the corpus, eval sets and ONNX model.
