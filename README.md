...
graph TD
    ...
    subgraph Data Pipeline
        ...
        MIG[Migration<br/>shards → vectors → Qdrant]
    end
...
shards into the dense vector array and metadata that `src/qdrant/migrate.py` loads.
